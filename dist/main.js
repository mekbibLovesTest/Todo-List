...
*/
  ...
  \*****************************/
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ changeCompleted: () =>
            /* binding */ changeCompleted,
          /* harmony export */ deleteProject: () => /* binding */ deleteProject,
          /* harmony export */ handleDeleteTodoButton: () =>
            /* binding */ handleDeleteTodoButton,
          /* harmony export */ handleEditSubmit: () =>
            /* binding */ handleEditSubmit,
          /* harmony export */ handleProjectSubmit: () =>
            /* binding */ handleProjectSubmit,
          /* harmony export */ handleTodoSubmit: () =>
            /* binding */ handleTodoSubmit,
        ...
        /* harmony import */ var _projectSection__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! ./projectSection */ "./src/projectSection.js",
          );
        /* harmony import */ var _projects__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(/*! ./projects */ "./src/projects.js");
        /* harmony import */ var _dialog__WEBPACK_IMPORTED_MODULE_4__ =
          __webpack_require__(/*! ./dialog */ "./src/dialog.js");
        ...
        function handleProjectSubmit(e) {
          ...
          if (projectTitle.value === "") return;
            ...
            let newProject = (0,
            _project__WEBPACK_IMPORTED_MODULE_1__["default"])(
              projectTitle.value,
            );
            _projects__WEBPACK_IMPORTED_MODULE_3__.projects.addProject(
              newProject,
            );
        ...
        function handleTodoSubmit(e) {
          if (validateTodoForm(getTodoData()) === false) return;
          else {
            e.preventDefault();

            let todoDialog = document.querySelector("#todo");
            let todoData = getTodoData();
            let todo = (0, _todo__WEBPACK_IMPORTED_MODULE_0__["default"])(
              todoData.title,
            ...
            _projects__WEBPACK_IMPORTED_MODULE_3__.projects
              .findProject(e.target.getAttribute("data-attribute"))
              .handleNewTodo(todo);
        ...
        function handleDeleteTodoButton(e) {
          var project =
            _projects__WEBPACK_IMPORTED_MODULE_3__.projects.findProject(
        ...
        function changeCompleted(e) {
          ...
          localStorage.setItem(
            "projects",
            (0, _projects__WEBPACK_IMPORTED_MODULE_3__.stringifyProjects)(
              _projects__WEBPACK_IMPORTED_MODULE_3__.projects,
            ),
          );
        }
        ...
        function deleteProject(e) {
          _projects__WEBPACK_IMPORTED_MODULE_3__.projects.deleteProject(
            e.target.getAttribute("projectId"),
          );
          resetPage();
        }
  ...
  \***********************/
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ addCancelEventListeners: () =>
            /* binding */ addCancelEventListeners,
          /* harmony export */ closeDialog: () => /* binding */ closeDialog,
          /* harmony export */ formatDate: () => /* binding */ formatDate,
          /* harmony export */ openAddTodoDialog: () =>
            /* binding */ openAddTodoDialog,
          /* harmony export */ openEditTodoDialog: () =>
            /* binding */ openEditTodoDialog,
          /* harmony export */ openProjectDialog: () =>
            /* binding */ openProjectDialog,
          /* harmony export */ resetForm: () => /* binding */ resetForm,
          /* harmony export */
        });
        /* harmony import */ var _projects__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ./projects */ "./src/projects.js");
        /* harmony import */ var _buttonHandle__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(/*! ./buttonHandle */ "./src/buttonHandle.js");
        ...
        function addCancelEventListeners() {
          ...
          projectCancel.addEventListener("click", (e) => {
            ...
            (0, _buttonHandle__WEBPACK_IMPORTED_MODULE_1__.resetPage)(
              projectDialog,
              "project",
            );
          });
        ...
        function openEditTodoDialog(e) {
          ...
          var project =
            _projects__WEBPACK_IMPORTED_MODULE_0__.projects.findProject(
              projectId,
            );
          var todo = project.findTodo(todoId);
        ...
        function resetForm(type) {
          if (type === "project") {
            ...
            dueDate.value = "";
            let checkedPriority = document.querySelector(
              "input[type='radio']:checked",
            );
        ...
        function populateDialogInput(todo) {
          ...
          var checkedPriority = document.querySelector(
            "input[type='radio']:checked",
          );
          checkedPriority.checked = false;
        ...
        function addProjectSubmitEventListener() {
          ...
          submitProject.addEventListener(
            "click",
            _buttonHandle__WEBPACK_IMPORTED_MODULE_1__.handleProjectSubmit,
          );
        }
        ...
        function addTodoSubmitButtonEventListener(id) {
          ...
          submitButton.addEventListener(
            "click",
            _buttonHandle__WEBPACK_IMPORTED_MODULE_1__.handleTodoSubmit,
          );
        }
        ...
        function addEditTodoSubmitEventListener(projectId, todoId) {
          ...
          editButton.addEventListener(
            "click",
            _buttonHandle__WEBPACK_IMPORTED_MODULE_1__.handleEditSubmit,
          );
        }
  ...
  \*******************************/
      /***/ (
        ...
        /* harmony import */ var _projects__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(/*! ./projects */ "./src/projects.js");
        /* harmony import */ var _dialog__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(/*! ./dialog */ "./src/dialog.js");
        /* harmony import */ var _buttonHandle__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(/*! ./buttonHandle */ "./src/buttonHandle.js");
        ...
        function createProjectSection() {
          ...
          (0, _projects__WEBPACK_IMPORTED_MODULE_1__.populateProjects)(
            JSON.parse(localStorage.getItem("projects")),
          );
          projectsDiv.append(
            ...createProjectCards(
              _projects__WEBPACK_IMPORTED_MODULE_1__.projects.getProjectList(),
            ),
          );
        }
        ...
        function initializeLocalStorage() {
          ...
          _project__WEBPACK_IMPORTED_MODULE_0__["default"])("default");
          _projects__WEBPACK_IMPORTED_MODULE_1__.projects.addProject(
            defaultProject,
          );
          localStorage.setItem(
            "projects",
            (0, _projects__WEBPACK_IMPORTED_MODULE_1__.stringifyProjects)(
        ...
        function createProjectCard(project) {
          ...
          projectCard.append(
            projectTitle,
            createButtonsDiv(project.getId()),
            createTodoListDiv(project),
          );
        ...
        function createAddTodoButton(projectId) {
          ...
          addToDoButton.addEventListener(
            "click",
            _dialog__WEBPACK_IMPORTED_MODULE_2__.openAddTodoDialog,
          );
        ...
        function createProjectDeleteButton(projectId) {
          ...
          deleteProjectButton.addEventListener(
            "click",
            _buttonHandle__WEBPACK_IMPORTED_MODULE_3__.deleteProject,
          );
        ...
        function createTodoDiv(project, todo) {
          ...
          wrapperDivLeft.append(
            createTodoTitle(todo.getTitle()),
            createTodoDate(todo.getDueDate()),
            createEditButton(project.getId(), todo.getId()),
          );

          var wrapperDivRight = document.createElement("div");
          wrapperDivRight.append(
            createDeleteTodoButton(project.getId(), todo.getId()),
            createPriorityElement(todo.getPriority()),
            createCheckDiv(project.getId(), todo.getId(), todo.getCompleted()),
          );
        ...
        function createTodoDate(dueDate) {
          ...
          todoDate.textContent = (0,
          _dialog__WEBPACK_IMPORTED_MODULE_2__.formatDate)(dueDate);
          todoDate.setAttribute(
            "datetime",
            (0, _dialog__WEBPACK_IMPORTED_MODULE_2__.formatDate)(dueDate),
          );
        ...
        function createDeleteTodoButton(projectId, todoId) {
          ...
          deleteTodoButton.addEventListener(
            "click",
            _buttonHandle__WEBPACK_IMPORTED_MODULE_3__.handleDeleteTodoButton,
            true,
          );
        ...
        function createEditButton(projectId, todoId) {
          ...
          editButton.addEventListener(
            "click",
            _dialog__WEBPACK_IMPORTED_MODULE_2__.openEditTodoDialog,
          );
        ...
        function createCheckDiv(projectId, todoId, completed) {
          ...
          div.append(
            createCheckInput(projectId, todoId, completed),
            createCompletedLabel(projectId, todoId),
          );
        ...
        function createCheckInput(projectId, todoId, completed) {
          ...
          inputCheck.addEventListener(
            "click",
            _buttonHandle__WEBPACK_IMPORTED_MODULE_3__.changeCompleted,
          );
  ...
  \*************************/
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ populateProjects: () =>
            /* binding */ populateProjects,
          /* harmony export */ projects: () => /* binding */ projects,
          /* harmony export */ stringifyProjects: () =>
            /* binding */ stringifyProjects,
          /* harmony export */
        });
        /* harmony import */ var _project__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ./project */ "./src/project.js");
        ...
        function populateProjects(projectFromStorage) {
          ...
          projectFromStorage.forEach((project) => {
            var newProject = (0,
            _project__WEBPACK_IMPORTED_MODULE_0__["default"])(project["title"]);
            project["todoList"].forEach((todo) => {
              var newTodo = (0, _todo__WEBPACK_IMPORTED_MODULE_1__["default"])(
                todo["title"],
                todo["description"],
  ...
  \**********************/
    __webpack_require__.r(__webpack_exports__);
    /* harmony import */ var _projectSection__WEBPACK_IMPORTED_MODULE_0__ =
      __webpack_require__(/*! ./projectSection */ "./src/projectSection.js");
    /* harmony import */ var _dialog__WEBPACK_IMPORTED_MODULE_1__ =
      __webpack_require__(/*! ./dialog */ "./src/dialog.js");
    ...
    addProjectButton.addEventListener(
      "click",
      _dialog__WEBPACK_IMPORTED_MODULE_1__.openProjectDialog,
    );
  })();
